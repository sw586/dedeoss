...
function ChangeSon()
{
    ...
    */
	...
	oj.setAttribute("lay-ignore","");
    oj.setAttribute("class","layui-select");
	oj.style.display = 'inline-block';
...
function MakeTopSelect(emname, selvalue)
{
    ...
    selObj.setAttribute("lay-ignore","");
    selObj.setAttribute("class","layui-select");
